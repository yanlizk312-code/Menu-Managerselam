...
export const INITIAL_MENU = [
  ...
  { id: "manti",         name: { en: "Turkish Dumplings",   am: "ማንቲ"               }, description: { en: "Handmade Turkish dumplings with yogurt",          am: "ከእርጎ ጋር የቱርክ ዱምፕሊንግ"               }, price: 135, category: "main",      image: U("1559058789-672da06263d8"), hidden: false },
  ...
  { id: "turk-cayi",     name: { en: "Turkish Tea",         am: "ቱርካዊ ሻይ"           }, description: { en: "Brewed Turkish black tea",                        am: "የቱርክ ጥቁር ሻይ"                       }, price: 15,  category: "drinks",    image: U("1564890369478-c89ca6d9cde9"), hidden: false },
  { id: "turk-kahvesi",  name: { en: "Turkish Coffee",      am: "ቱርካዊ ቡና"           }, description: { en: "Traditional Turkish coffee",                      am: "ባህላዊ ቱርካዊ ቡና"                      }, price: 35,  category: "drinks",    image: U("1514432324607-a09d9b4aefdd"), hidden: false },
